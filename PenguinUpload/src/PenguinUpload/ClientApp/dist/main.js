	...
	exports.default = {
	  ...
	  methods: {
	    downloadFile: function downloadFile() {
	      window.location.href =  true ? '!' + this.file.pass : '';
	    },
